...
namespace longest_non_duplicate_substring {
...
int longest_unique_substtr(char *str, int NUM)
{
    int n = strlen(str);
    ...
    int i;
    int *visited = (int *)malloc(sizeof(int)*255);
    ...
    for (i = 1; i < n; i++)
    {
        ...
        visited[int(str[i])] = i; // update the index of current character
    }
